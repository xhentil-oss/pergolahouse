    ...
    <div className="relative overflow-x-hidden bg-white font-inter_tight text-neutral-900">
      ...
      <main role="main">
        ...
        <section style={{ backgroundColor: '#344148' }}>
          ...
          <div className="mx-auto flex max-w-[1440px] flex-col gap-6 px-5 pb-10 pt-4 md:px-12 lg:grid lg:grid-cols-[58fr_42fr] lg:gap-8 lg:px-16 lg:pb-16">
            {/* LEFT: Gallery */}
            ...
            <div className="w-full lg:max-h-[calc(100vh+130px)] lg:overflow-y-auto lg:pb-6 [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none' }}>
              <div className="rounded-3xl bg-white p-6 shadow-2xl md:p-7 lg:min-h-full lg:flex lg:flex-col">
                ...
                <div className="mt-5 space-y-5">
                  ...
                  {/* CTA buttons */}
                  <div className="grid gap-2 sm:grid-cols-2 pt-1 lg:mt-auto lg:sticky lg:bottom-0 lg:bg-white lg:-mx-7 lg:px-7 lg:pb-4 lg:pt-3 lg:border-t lg:border-stone-100 lg:rounded-b-3xl">
