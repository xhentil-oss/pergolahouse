  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        onClick={() => dropdownItems && setOpen((p) => !p)}
        className="items-center gap-x-1.5 flex font-semibold leading-5 mr-2 cursor-pointer bg-transparent border-0 p-0"
      >
        <a href={href} className="hover:text-zinc-600 transition-colors">{label}</a>
        {dropdownItems && (
          <img
